...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ppt_sizes = QtWidgets.QLabel(self.init_data)
        self.ppt_sizes.setObjectName("ppt_sizes")
        self.verticalLayout_6.addWidget(self.ppt_sizes)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setContentsMargins(0, 0, -1, -1)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.ppt_height_label = QtWidgets.QLabel(self.init_data)
        self.ppt_height_label.setObjectName("ppt_height_label")
        self.horizontalLayout.addWidget(self.ppt_height_label)
        self.init_data_height = QtWidgets.QLineEdit(self.init_data)
        self.init_data_height.setObjectName("init_data_height")
        self.horizontalLayout.addWidget(self.init_data_height)
        self.ppt_width_label = QtWidgets.QLabel(self.init_data)
        self.ppt_width_label.setObjectName("ppt_width_label")
        self.horizontalLayout.addWidget(self.ppt_width_label)
        self.init_data_width = QtWidgets.QLineEdit(self.init_data)
        self.init_data_width.setObjectName("init_data_width")
        self.horizontalLayout.addWidget(self.init_data_width)
    ...
    def retranslateUi(self, Form):
        ...
        self.ppt_sizes.setText(_translate("Form", "Размеры пакетов"))
        self.ppt_height_label.setText(_translate("Form", "H"))
        self.ppt_width_label.setText(_translate("Form", "W"))
        self.init_data_height.insert("2000")
        self.init_data_width.insert("1000")
